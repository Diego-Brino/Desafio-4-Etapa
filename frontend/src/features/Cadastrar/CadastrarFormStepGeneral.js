                    ...
                    <Grid item xs={12} lg={6}>
                        <Stack spacing={2}>
                            ...
                            <TextField
                                ...
                                helperText={props.formik.errors.lattes != null ? props.formik.errors.lattes : ' '}
                            />
                            <TextField
                                ...
                                helperText={props.formik.errors.email != null ? props.formik.errors.email : ' '}
                            />
                            <PasswordField
                    ...
                    <Grid item xs={12} lg={6}>
                        <Stack spacing={2}>
                            <TextField
                                ...
                                onChange={props.formik.handleChange}
                                inputProps={{maxLength: 50}}
                                helperText={props.formik.errors.nome != null ? props.formik.errors.nome : ' '}
                            />
                            <TextField
                                ...
                                onChange={props.formik.handleChange}
                                type='date'
                                helperText={props.formik.errors.dataNascimento != null ? props.formik.errors.dataNascimento : ' '}
                            />
                            <TextField
                                ...
                                helperText={props.formik.errors.emailAlternativo != null ? props.formik.errors.emailAlternativo : ' '}
                            />
                            <MaskedField
                                mask={'(99)99999-9999'}
